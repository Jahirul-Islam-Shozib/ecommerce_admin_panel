...
export class MenuComponent implements OnInit {
  ...
  ngOnInit() {
    this.model = [
      ...
      {
        label: this.accessChecker.hasAccessToEDCR() ? 'Orders' : undefined,
        items: [
          {
            label: 'Order List', icon: 'pi pi-clone', routerLink: ['/order/list'],
            visible: this.accessChecker.hasAccessToEDCR()
          }
        ],
      },
      {
        label: this.accessChecker.hasAccessToEDCR() ? 'Users' : undefined,
        items: [
          {
            label: 'User List', icon: 'pi pi-clone', routerLink: ['/user/list'],
            visible: this.accessChecker.hasAccessToEDCR()
          }
        ],
      },
